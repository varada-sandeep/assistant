...
esp32_ip = "http://192.168.29.153"  # Use the actual IP address of your ESP32
...
def username():
    speak("HI, WELCOME I AM YOUR PERSONALIZED VOICE ASSISTANT")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "hey friday" in query:
            wishMe()
            speak("Tell me what i can do for you boss")
            query = takeCommand().lower()
            if "wikipedia" in query:
                speak("Searching Wikipedia...")
                query = query.replace("wikipedia", "")
                results = wikipedia.summary(query, sentences=3)
                speak("hmmmmmmmmmmmmmm  According to Wikipedia")
                print(results)
                speak(results)
            ...
            elif "turn the light on" in query or "turn on the light" in query or "light on" in query or "on the light" in query:
                start_blinking()
                speak("Turning on the light")
            
            elif "turn the light off" in query or "turn off the light" in query or "light off" in query or "off the light" in query:
                stop_blinking()
                ...
                speak("I have been created by Sandeep.")
                ...
                speak("I am your virtual assistant created by Sandeep")

            elif "reason for you" in query:
                speak("I was created as a Minor project by Mister Sandeep ")
